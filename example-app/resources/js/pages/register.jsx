...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const res = await axios.post('http://127.0.0.1:8000/api/register', { email, password });
          ...
          <div className="p-8 flex-1" style={{fontFamily: "'Bitcount Prop Double', sans-serif"}}>
            <div className="w-80 bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">
              ...
              <div className="px-10 pt-2 pb-8 bg-white rounded-tr-4xl">
                ...
                <motion.a onClick={() => navigate("/login")} className="cursor-pointer mt-4 block text-sm text-center font-medium text-gray-600 hover:underline focus:outline-none focus:ring-2 focus:ring-gray-500">
                    Login?
                </motion.a>
              </div>
            </div>
